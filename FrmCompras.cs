    ...
    public partial class FrmCompras : Form
    {
        ...
        private void btnAddCompra_Click(object sender, EventArgs e)
        {
            ...
            if (flag)
            {
                ...
                compra.PrecioFinal = precioFinal.ToString();
                
                switch(cbxTipoProducto.Text)
                {
                    case "Arma":
                        compras.Add(new Compra(compra.Nombre, Arma.Emarca.Winchester, compra.PrecioUnitario, compra.Cantidad, compra.PrecioFinal, compra.Empleado));
                        break;

                    case "Bebida":
                        compras.Add(new Compra(compra.Nombre, Bebida.Emarca.CocaCola, compra.PrecioUnitario, compra.Cantidad, compra.PrecioFinal, compra.Empleado));
                        break;

                    case "Hamburguesa":
                        compras.Add(new Compra(compra.Nombre, Hamburguesa.Emarca.Crusty, compra.PrecioUnitario, compra.Cantidad, compra.PrecioFinal, compra.Empleado));
                        break;

                    case "Lacteo":
                        compras.Add(new Compra(compra.Nombre, Lacteo.Emarca.Tony, compra.PrecioUnitario, compra.Cantidad, compra.PrecioFinal, compra.Empleado));
                        break;

                    case "Limpieza":
                        compras.Add(new Compra(compra.Nombre, Limpieza.Emarca.Ayudín, compra.PrecioUnitario, compra.Cantidad, compra.PrecioFinal, compra.Empleado));
                        break;
                ...
                {
                    precioCompra = precioCompra + float.Parse(compra.PrecioFinal);
